...
% Solve the ODE
[t1,w1] = ode45(@proj,tspan,r0,opts,g,L,gamma1,A,omega(3));
...
% Solve the ODE
[t2,w2] = ode45(@proj,tspan,r0,opts,g,L,gamma1,A,omega(3));
...
% Now we do these again for different values of omega
...
% Solve the ODE
[t1,w1] = ode45(@proj,tspan,r0,opts,g,L,gamma1,A,omega(2));
...
[t0,w0] = ode45(@proj,tspan,r0,opts,g,L,gamma(1),A,omega);
